...
The code is laid out awfully, I had a lot of misconceptions about how inlining functions worked, and I hadn't yet learned a lot of C++ best
practices.

It's definitely good for the time, but I can do a lot better now, I think. I plan to make another gravity 
simulation eventually, this time using OpenGL, leveraging compute shaders to do the updating in proper parallel, and
